...
import {
  getBlockType,
  setBlockType
} from "src/front-end/typescript/lib/components/platejs/components/editor/transforms";
...
export function TurnIntoToolbarButton(props: DropdownMenuProps) {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen} modal={false} {...props}>
      ...
      <DropdownMenuContent
        className="tw:ignore-click-outside/toolbar tw:min-w-0"
        onCloseAutoFocus={(e) => {
          e.preventDefault();
          editor.tf.focus();
        }}
