...
function PureColorPicker({
  ...
  return (
    <div className={cn("tw:flex tw:flex-col", className)} {...props}>
      ...
      {color && (
        <ToolbarMenuGroup>
          <DropdownMenuItem className="tw:p-2" onClick={clearColor}>
            <EraserIcon />
            <span>Clear</span>
          </DropdownMenuItem>
        </ToolbarMenuGroup>
...
function ColorCustom({
  ...
  return (
    <div
      className={cn("tw:relative tw:flex tw:flex-col tw:gap-4", className)}
      {...props}>
      <ColorDropdownMenuItems
        color={color}
        ...
        <ColorInput
          ...
          <DropdownMenuItem
            className={cn(
              ...
              "tw:absolute tw:top-1 tw:right-2 tw:bottom-2 tw:flex tw:size-8 tw:items-center tw:justify-center tw:rounded-full"
            )}
            onSelect={(e) => {
              e.preventDefault();
            }}>
            <span className="tw:sr-only">Custom</span>
            <PlusIcon />
          </DropdownMenuItem>
        </ColorInput>
      </ColorDropdownMenuItems>
  ...
  return (
    <div className="tw:flex tw:flex-col tw:items-center">
      ...
      <input
        ...
        className={cn(
          "tw:size-0 tw:overflow-hidden tw:border-0 tw:p-0",
          className
        )}
        value={value}
        type="color"
...
function ColorDropdownMenuItem({
  ...
  const content = (
    <DropdownMenuItem
      className={cn(
        ...
        "tw:my-1 tw:flex tw:size-6 tw:items-center tw:justify-center tw:rounded-full tw:border tw:border-solid tw:border-muted tw:p-0 tw:transition-all tw:hover:scale-125",
        !isBrightColor && "tw:border-transparent",
        isSelected && "tw:border-2 tw:border-primary",
        className
      )}
  ...
  return name ? (
    <Tooltip>
      ...
      <TooltipContent className="tw:mb-1 tw:capitalize">{name}</TooltipContent>
    </Tooltip>
  ) : (
    content
  );
...
export function ColorDropdownMenuItems({
  ...
  return (
    <div
      className={cn(
        "tw:grid tw:grid-cols-[repeat(10,1fr)] tw:place-items-center tw:gap-x-1",
        className
      )}
      {...props}>
      <TooltipProvider>
