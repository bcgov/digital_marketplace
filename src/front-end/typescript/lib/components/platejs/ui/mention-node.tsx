  ...
  return (
    <PlateElement {...props} as="span">
      <InlineCombobox
        ...
        showTrigger={false}
        trigger="@">
        <span className="tw:inline-block tw:rounded-md tw:bg-muted tw:px-1.5 tw:py-0.5 tw:align-baseline tw:text-sm tw:ring-ring tw:focus-within:ring-2">
          <InlineComboboxInput />
        </span>

        <InlineComboboxContent className="tw:my-1.5">
