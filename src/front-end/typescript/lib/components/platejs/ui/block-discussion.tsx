...
// import { suggestionPlugin } from 'src/front-end/typescript/lib/components/platejs/components/editor/plugins/suggestion-kit';
...
//   //       <PopoverContent
//   //         className="tw:max-h-[min(50dvh,calc(-24px+var(--radix-popper-available-height)))] tw:w-[380px] tw:max-w-[calc(100vw-24px)] tw:min-w-[130px] tw:overflow-y-auto tw:p-0 tw:data-[state=closed]:opacity-0"
...
//   //       >
//   //         {isCommenting ? (
//   //           <CommentCreateForm className="tw:p-4" focusOnMount />
//   //         ) : (
//   //           <React.Fragment>
//   //             {noneActive ? (
...
//   //       {totalCount > 0 && (
//   //         <div className="tw:relative tw:left-0 tw:size-0 tw:select-none">
//   //           <PopoverTrigger asChild>
//   //             <Button
//   //               variant="ghost"
//   //               className="tw:mt-1 tw:ml-1 tw:flex tw:h-6 tw:gap-1 tw:!px-1.5 tw:py-0 tw:text-muted-foreground/80 tw:hover:text-muted-foreground/80 tw:data-[active=true]:bg-muted"
//   //               data-active={open}
//   //               contentEditable={false}
//   //             >
//   //               {suggestionsCount > 0 && discussionsCount === 0 && (
//   //                 <PencilLineIcon className="tw:size-4 tw:shrink-0" />
//   //               )}

//   //               {suggestionsCount === 0 && discussionsCount > 0 && (
//   //                 <MessageSquareTextIcon className="tw:size-4 tw:shrink-0" />
//   //               )}

//   //               {suggestionsCount > 0 && discussionsCount > 0 && (
//   //                 <MessagesSquareIcon className="tw:size-4 tw:shrink-0" />
//   //               )}

//   //               <span className="tw:text-xs tw:font-semibold">{totalCount}</span>
//   //             </Button>
//   //           </PopoverTrigger>
//   //         </div>
//   //       )}
...
//       {!isLast && <div className="tw:h-px tw:w-full tw:bg-muted" />}
//     </React.Fragment>
//   );
// }
