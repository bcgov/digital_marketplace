...
//     <div
//       className={cn(
//         "tw:pointer-events-none tw:absolute tw:inset-0 tw:z-1 tw:border-2 tw:border-brand/[0.8] tw:transition-opacity",
//         isRemove && "tw:border-gray-300"
//       )}
...
//         <div className="tw:relative tw:mt-1 tw:mb-4 tw:pl-[32px]">
...
//                     <span key={index} className="tw:text-sm">
//                       {text}
//                     </span>
//                   </div>
//                 ))}
...
//                       <div
//                         key={index}
//                         className="tw:flex tw:items-start tw:gap-2 tw:text-brand/80"
//                       >
//                         <span className="tw:text-sm">with:</span>
//                         <span className="tw:text-sm">{text || 'line breaks'}</span>
//                       </div>
//                     </React.Fragment>
//                   )
//                 )}
...
//                   ))}
//                 </span>
//                 <span className="tw:text-sm">{suggestion.newText}</span>
//               </div>
//             )}
//           </div>
//         </div>
...
//             <Button
//               variant="ghost"
//               className="tw:size-6 tw:p-1 tw:text-muted-foreground"
