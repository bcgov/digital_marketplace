  ...
  function MediaEmbedElement(props: PlateElementProps<TMediaEmbedElement>) {
    ...
    return (
      <MediaToolbar plugin={MediaEmbedPlugin}>
        <PlateElement className="tw:py-2.5" {...props}>
          <figure
            className="tw:group tw:relative tw:m-0 tw:w-full tw:cursor-default"
            ...
            <Resizable
              ...
              {isVideo ? (
                isYoutube ? (
                  ...
                  <div
                    ...
                    <iframe
                      className={cn(
                        "tw:absolute tw:top-0 tw:left-0 tw:size-full tw:rounded-sm",
                        isVideo && "tw:border-0",
                        focused &&
                          selected &&
              ...
              {isTweet && (
                <div
                  className={cn(
                    "tw:[&_.react-tweet-theme]:my-0",
                    !readOnly &&
                      selected &&
                      "tw:[&_.react-tweet-theme]:ring-2 tw:[&_.react-tweet-theme]:ring-ring tw:[&_.react-tweet-theme]:ring-offset-2"
                  )}>
                  <Tweet id={embed!.id!} />
                </div>
              )}
