...
} from "../ui/table-cell-element-static";
...
export function ExportToolbarButton(props: DropdownMenuProps) {
  ...
  const exportToHtml = async () => {
    ...
    const katexCss = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.16.18/dist/katex.css" integrity="sha384-9PvLvaiSKCPkFKB1ZsEoTjgnJn+O3KvEwtsz37/XrkYft3DTk2gHdYvd9oWgW3tV" crossorigin="anonymous">`; // pragma: allowlist secret
