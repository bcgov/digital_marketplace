import { DEFAULT_USER_AVATAR_IMAGE_PATH, PROCUREMENT_CONCIERGE_URL } from 'front-end/typescript/config';
import { fileBlobPath, prefixPath } from 'front-end/typescript/lib';
import getAppModal from 'front-end/typescript/lib/app/modal';
import { isAllowedRouteForUsersWithUnacceptedTerms, Msg, Route, State } from 'front-end/typescript/lib/app/types';
import Footer from 'front-end/typescript/lib/app/view/footer';
import * as Nav from 'front-end/typescript/lib/app/view/nav';
import ViewPage, { Props as ViewPageProps } from 'front-end/typescript/lib/app/view/page';
import { AppMsg, ComponentView, ComponentViewProps, Dispatch, Immutable, mapAppDispatch, mapComponentDispatch, mapPageModalMsg, PageModal, Toast as FrameworkToast, View } from 'front-end/typescript/lib/framework';
import * as PageContentCreate from 'front-end/typescript/lib/pages/content/create';
import * as PageContentEdit from 'front-end/typescript/lib/pages/content/edit';
import * as PageContentList from 'front-end/typescript/lib/pages/content/list';
import * as PageContentView from 'front-end/typescript/lib/pages/content/view';
import * as PageDashboard from 'front-end/typescript/lib/pages/dashboard';
import * as PageLanding from 'front-end/typescript/lib/pages/landing';
import * as PageLearnMoreCWU from 'front-end/typescript/lib/pages/learn-more/code-with-us';
import * as PageLearnMoreSWU from 'front-end/typescript/lib/pages/learn-more/sprint-with-us';
import * as PageNotFound from 'front-end/typescript/lib/pages/not-found';
import * as PageNotice from 'front-end/typescript/lib/pages/notice';
import * as PageOpportunityCWUCreate from 'front-end/typescript/lib/pages/opportunity/code-with-us/create';
import * as PageOpportunityCWUEdit from 'front-end/typescript/lib/pages/opportunity/code-with-us/edit';
import * as PageOpportunityCWUView from 'front-end/typescript/lib/pages/opportunity/code-with-us/view';
import * as PageOpportunityCreate from 'front-end/typescript/lib/pages/opportunity/create';
import * as PageOpportunities from 'front-end/typescript/lib/pages/opportunity/list';
import * as PageOpportunitySWUCreate from 'front-end/typescript/lib/pages/opportunity/sprint-with-us/create';
import * as PageOpportunitySWUEdit from 'front-end/typescript/lib/pages/opportunity/sprint-with-us/edit';
import * as PageOpportunitySWUView from 'front-end/typescript/lib/pages/opportunity/sprint-with-us/view';
import * as PageOrgCreate from 'front-end/typescript/lib/pages/organization/create';
import * as PageOrgEdit from 'front-end/typescript/lib/pages/organization/edit';
import * as PageOrgList from 'front-end/typescript/lib/pages/organization/list';
import * as PageOrgSWUTerms from 'front-end/typescript/lib/pages/organization/sprint-with-us-terms';
import * as PageProposalCWUCreate from 'front-end/typescript/lib/pages/proposal/code-with-us/create';
import * as PageProposalCWUEdit from 'front-end/typescript/lib/pages/proposal/code-with-us/edit';
import * as PageProposalCWUExportAll from 'front-end/typescript/lib/pages/proposal/code-with-us/export/all';
import * as PageProposalCWUExportOne from 'front-end/typescript/lib/pages/proposal/code-with-us/export/one';
import * as PageProposalCWUView from 'front-end/typescript/lib/pages/proposal/code-with-us/view';
import * as PageProposalList from 'front-end/typescript/lib/pages/proposal/list';
import * as PageProposalSWUCreate from 'front-end/typescript/lib/pages/proposal/sprint-with-us/create';
import * as PageProposalSWUEdit from 'front-end/typescript/lib/pages/proposal/sprint-with-us/edit';
import * as PageProposalSWUExportAll from 'front-end/typescript/lib/pages/proposal/sprint-with-us/export/all';
import * as PageProposalSWUExportOne from 'front-end/typescript/lib/pages/proposal/sprint-with-us/export/one';
import * as PageProposalSWUView from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view';
import * as PageSignIn from 'front-end/typescript/lib/pages/sign-in';
import * as PageSignOut from 'front-end/typescript/lib/pages/sign-out';
import * as PageSignUpStepOne from 'front-end/typescript/lib/pages/sign-up/step-one';
import * as PageSignUpStepTwo from 'front-end/typescript/lib/pages/sign-up/step-two';
import * as PageUserList from 'front-end/typescript/lib/pages/user/list';
import * as PageUserProfile from 'front-end/typescript/lib/pages/user/profile';
import { ThemeColor } from 'front-end/typescript/lib/types';
import Icon, { AvailableIcons } from 'front-end/typescript/lib/views/icon';
import Link, { externalDest, iconLinkSymbol, imageLinkSymbol, leftPlacement, rightPlacement, routeDest } from 'front-end/typescript/lib/views/link';
