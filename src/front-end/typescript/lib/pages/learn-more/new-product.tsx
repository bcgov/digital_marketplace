    ...
    <div className="bg-c-learn-more-bg pt-4 pb-6 pb-md-7">
      <Container>
        ...
        <Row>
          <Col xs="12" md="8">
            <p className="mb-0">
              <em>New Product</em> is a procurement mechanism that allows the{' '}
      ...
      <Container>
        <Row>
          <Col xs="12" md="8">
            ...
            >
              <p className="mb-5">
                If your organization is awarded a New Product opportunity, here
                is what you can expect when you work with us:
              </p>
              <Row>
                <Col xs="12" md="6">
                  <InfoBlockView
      ...
      <Container>
        <Row>
          <Col xs="12" md="8">
            ...
            >
              <p className="mb-4">
                To apply for <em>New Product</em> opportunities, complete the
                following steps:
              </p>
              <HowItWorksItem
                symbol_={adt('text', '1')}
                ...
                description={
                  <div>
                    <p>
                      ...
                      <em>New Product</em> opportunities.
                    </p>
                    <p className="mb-0">
...
export const component: PageComponent<RouteParams, SharedState, State, Msg> = {
  ...
  view,
  getMetadata() {
    return makePageMetadata('New Product - Learn More');
  }
};
