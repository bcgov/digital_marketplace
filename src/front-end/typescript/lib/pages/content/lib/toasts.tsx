...
export const published = {
  success: (content: MiniContent) => ({
    ...
    body: (
      <span>
        <ContentLink {...content} newTab /> has been published.
      </span>
    )
  }),
  error: {
...
export const changesPublished = {
  success: (content: MiniContent) => ({
    ...
    body: (
      <span>
        Your changes to <ContentLink {...content} newTab /> have been published.
      </span>
    )
  }),
  error: {
...
export const notifiedNewTerms = {
  success: {
    ...
    body: (
      <span>
        All vendors have been notified that the <em>{COPY.appTermsTitle}</em>{" "}
        have been updated. They will now be prompted to accept the updated terms
        before submitting their next proposal to an opportunity.
      </span>
    )
  },
  error: {
    ...
    body: (
      <span>
        The system was unable to notify vendors of the updated{" "}
        <em>{COPY.appTermsTitle}</em>. Please try again later.
      </span>
    )
  }
};
