import { SWU_PROPOSAL_EVALUATION_CONTENT_ID } from 'front-end/typescript/config';
import { getAlertsValid, getContextualActionsValid, getMetadataValid, getModalValid, makePageMetadata, makeStartLoading, makeStopLoading, sidebarValid, updateValid, viewValid } from 'front-end/typescript/lib';
...
import * as SubmitProposalTerms from 'front-end/typescript/lib/components/submit-proposal-terms';
import { ComponentView, GlobalComponentMsg, Immutable, immutable, mapComponentDispatch, mapPageModalMsg, newRoute, PageComponent, PageInit, replaceRoute, toast, Update, updateComponentChild } from 'front-end/typescript/lib/framework';
import * as api from 'front-end/typescript/lib/http/api';
import * as Form from 'front-end/typescript/lib/pages/proposal/sprint-with-us/lib/components/form';
import * as toasts from 'front-end/typescript/lib/pages/proposal/sprint-with-us/lib/toasts';
import Link, { iconLinkSymbol, leftPlacement, routeDest } from 'front-end/typescript/lib/views/link';
