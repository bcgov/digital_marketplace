...
import { ComponentViewProps, immutable, Immutable, Init, mapComponentDispatch, PageGetModal, Update, updateComponentChild, View } from 'front-end/typescript/lib/framework';
...
import Link, { iconLinkSymbol, imageLinkSymbol, leftPlacement, routeDest } from 'front-end/typescript/lib/views/link';
