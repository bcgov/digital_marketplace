    ...
    <div className={className}>
      <Row>
        <Col xs="12">
          <h3 className="mb-4">
            {anonymous
              ? "Anonymized Proponent Team Questions"
              : "Sprint With Us Proposal"}
          </h3>
          <DescriptionList
            items={[
              ...
              showOpportunityInformation
                ...
                : null,
              showOpportunityInformation
                ? { name: "Opportunity Type", children: "Sprint With Us" }
                : null,
              {
                name: "Proponent",
                children: anonymous
              ...
              !anonymous
                ? {
                    ...
                    children: (
                      <Badge
                        text={swuProposalStatusToTitleCase(
                          proposal.status,
                          exportedBy?.type || UserType.Vendor
                        )}
                        color={swuProposalStatusToColor(
                          proposal.status,
                          exportedBy?.type || UserType.Vendor
                        )}
                      />
          ...
          <Col xs="12">
            ...
            <DescriptionList
              items={[
                ...
                {
                  name: "Team Scenario",
                  children: proposal.scenarioScore
                    ? `${proposal.scenarioScore.toFixed(2)} %`
                    : "-"
                },
                {
                  name: "Price",
