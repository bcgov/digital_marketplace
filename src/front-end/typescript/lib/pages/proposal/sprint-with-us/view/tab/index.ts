...
import * as CodeChallengeTab from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view/tab/code-challenge';
import * as HistoryTab from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view/tab/history';
import * as ProposalTab from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view/tab/proposal';
import * as TeamQuestionsTab from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view/tab/team-questions';
import * as TeamScenarioTab from 'front-end/typescript/lib/pages/proposal/sprint-with-us/view/tab/team-scenario';
