...
export function cwuProposalStatusToColor(
  s: CWUProposalStatus,
...
export function cwuProposalStatusToTitleCase(
  s: CWUProposalStatus,
  viewerUserType: UserType
): string {
  switch (s) {
    ...
    case CWUProposalStatus.UnderReview:
      return "Under Review";
    case CWUProposalStatus.Evaluated:
      return viewerUserType === UserType.Vendor ? "Under Review" : "Evaluated";
    case CWUProposalStatus.Awarded:
      return "Awarded";
    case CWUProposalStatus.NotAwarded:
      return "Not Awarded";
...
export function cwuProposalEventToTitleCase(e: CWUProposalEvent): string {
  switch (e) {
    case CWUProposalEvent.ScoreEntered:
      return "Score Entered";
  }
}

export function cwuProposalStatusToPresentTenseVerb(
  s: CWUProposalStatus
): string {
  switch (s) {
    case CWUProposalStatus.Draft:
