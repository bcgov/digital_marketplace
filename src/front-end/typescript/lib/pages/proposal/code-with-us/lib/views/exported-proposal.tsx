          ...
          <DescriptionList
            items={[
              ...
              showOpportunityInformation
                ...
                : null,
              showOpportunityInformation
                ? { name: "Opportunity Type", children: "Code With Us" }
                : null,
              { name: "Proponent", children: getCWUProponentName(proposal) },
              {
                name: "Proponent Type",
                children: getCWUProponentTypeTitleCase(proposal)
              },
              { name: "Vendor", children: proposal.createdBy.name },
              proposal.score
                ? { name: "Score", children: `${proposal.score}%` }
                : null,
              exportedBy
        ...
        <Row className="mt-5">
          <Col xs="12">
            ...
            <div>
              <ProposalMarkdown
                box
                source={proposal.additionalComments}
                noLinks={false}
                noImages={false}
              />
            </div>
