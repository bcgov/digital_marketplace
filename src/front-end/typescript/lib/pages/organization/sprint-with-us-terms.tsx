import { SWU_QUALIFICATION_TERMS_ID } from 'front-end/typescript/config';
import { getAlertsValid, makePageMetadata, makeStartLoading, makeStopLoading, updateValid, viewValid } from 'front-end/typescript/lib';
...
import { ComponentView, GlobalComponentMsg, immutable, Immutable, newRoute, PageComponent, PageInit, replaceRoute, toast, Update } from 'front-end/typescript/lib/framework';
