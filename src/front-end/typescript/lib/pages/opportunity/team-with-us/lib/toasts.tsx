...
export const submittedQuestionEvaluationScoresForConsensus = {
  success: {
    ...
    body: "Your evaluations for this Team With Us opportunity have been submitted for consensus."
  },
  error: {
    title: "Unable to Submit Evaluations for Consensus",
    body: "Your evaluations for this Team With Us opportunity could not be submitted for consensus. Please try again later."
  }
};
...
export const submittedQuestionEvaluationConsensuses = {
  success: {
    ...
    body: "Your consensuses for this Team With Us opportunity have been submitted."
  },
  error: {
    title: "Unable to Submit Consensuses",
    body: "Your consensuses for this Team With Us opportunity could not be submitted. Please try again later."
  }
};
...
export const finalizedQuestionEvaluationConsensuses = {
  success: {
    ...
    body: "Your consenuses for this Team With Us opportunity have been finalized."
  },
  error: {
    title: "Unable to Finalize Consensuses",
    body: "Your consensuses for this Team With Us opportunity could not be finalized. Please try again later."
  }
};
