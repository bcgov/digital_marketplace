...
6. getOpportunityFieldValue() - Use when user wants to check the current value of a field before updating it
7. addResource() - Use when user describes resource needs (e.g., "DevOps Engineer", "Frontend Developer") - automatically fills existing blank resources first
