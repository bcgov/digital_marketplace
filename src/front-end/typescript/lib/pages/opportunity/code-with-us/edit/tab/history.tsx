...
import {
  historyToHistoryTableRow,
  createHistoryNote,
  isNoteValid,
  isAttachmentValid,
  createAttachmentError,
  createNoteError
} from "front-end/lib/pages/opportunity/helpers";
import {
  MAX_NOTE_LENGTH,
  MAX_NOTE_ATTACHMENT_SIZE,
  SUPPORTED_NOTE_ATTACHMENT_FORMATS,
  SUPPORTED_NOTE_ATTACHMENT_EXTENSIONS
} from "shared/lib/resources/note";
        ...
        return {
          ...
          body: (dispatch) => {
            ...
            return (
              <div>
                <p>
                  Provide a note or commentary below pertaining to the
                  opportunity. You may also include any applicable attachments.
                </p>
                <Alert color="danger" style={{ whiteSpace: "pre-line" }}>
                  <strong>Important! </strong>The notes and any attachments, if
                  applicable, cannot be edited or deleted once submitted.
                </Alert>
          ...
          actions: [
            {
              ...
              button: true,
              disabled:
                !isNoteValid(state, MAX_NOTE_LENGTH) ||
                !isAttachmentValid(
                  state,
                  MAX_NOTE_ATTACHMENT_SIZE,
                  SUPPORTED_NOTE_ATTACHMENT_FORMATS
