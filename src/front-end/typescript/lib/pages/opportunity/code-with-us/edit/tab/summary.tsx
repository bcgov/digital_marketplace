...
import { ComponentView, GlobalComponentMsg, Init, Update } from 'front-end/typescript/lib/framework';
...
import Link, { emailDest, routeDest } from 'front-end/typescript/lib/views/link';
