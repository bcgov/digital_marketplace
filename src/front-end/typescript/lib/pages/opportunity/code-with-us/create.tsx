        ...
        async (state, dispatch) => {
          const result = await Form.persist(
            ...
            adt(
              "create",
              isPublish
                ? (CWUOpportunityStatus.Published as const)
                : (CWUOpportunityStatus.Draft as const)
            )
          );
          switch (result.tag) {
            case "valid": {
              ...
              dispatch(
                newRoute(
                  adt("opportunityCWUEdit" as const, {
                    opportunityId,
                    tab: isPublish
                      ? ("summary" as const)
              ...
              dispatch(
                toast(
                  adt(
                    "success",
                    isPublish
                      ? toasts.published.success(opportunityId)
