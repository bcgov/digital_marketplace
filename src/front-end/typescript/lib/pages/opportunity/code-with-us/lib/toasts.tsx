import {
  cwuOpportunityStatusToPastTenseVerb,
  cwuOpportunityStatusToPresentTenseVerb
...
export const statusChanged = {
  ...
  error: (s: CWUOpportunityStatus) => {
    return {
      title: `Unable to ${cwuOpportunityStatusToPresentTenseVerb(
        s
      )} Opportunity`,
      body: `Code With Us opportunity could not be ${cwuOpportunityStatusToPastTenseVerb(
        s
        ...
        <div>
          ...
          <div className="mt-2">
            <Link
              ...
              dest={routeDest(adt("opportunityCWUView", { opportunityId }))}>
              View opportunity
            </Link>
          </div>
        </div>
