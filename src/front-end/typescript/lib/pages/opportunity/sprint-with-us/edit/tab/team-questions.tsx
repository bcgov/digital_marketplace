...
import { ComponentView, Dispatch, GlobalComponentMsg, immutable, Immutable, Init,  mapComponentDispatch, newRoute, toast, Update, updateComponentChild, View } from 'front-end/typescript/lib/framework';
...
import * as proposalToasts from 'front-end/typescript/lib/pages/proposal/sprint-with-us/lib/toasts';
          ...
          <Col xs='12' className='d-flex flex-column flex-md-row justify-content-md-between align-items-start align-items-md-center mb-4'>
            ...
            {state.canViewProposals
              ? (<Link
                  ...
                  dest={routeDest(adt('proposalSWUExportAll', { opportunityId: opportunity.id, anonymous: true }))}>
