import { SEARCH_DEBOUNCE_DURATION, TRUNCATE_OPPORTUNITY_TITLE_LENGTH } from 'front-end/typescript/config';
import { makePageMetadata, makeStartLoading, makeStopLoading } from 'front-end/typescript/lib';
...
import { ComponentView, Dispatch, GlobalComponentMsg, Immutable, immutable, mapComponentDispatch, PageComponent, PageInit, Update, updateComponentChild, View } from 'front-end/typescript/lib/framework';
import * as api from 'front-end/typescript/lib/http/api';
import Accordion from 'front-end/typescript/lib/views/accordion';
import Badge, { OpportunityBadge } from 'front-end/typescript/lib/views/badge';
import { IconInfo } from 'front-end/typescript/lib/views/icon';
