...
export function parseUserTypeList<UserType>(
  list: string[],
  parseOneUserType: (raw: string) => UserType | null
): UserType[] | null {
...
const MARKDOWN_IMAGE_URL_PREFIX_REGEXP = new RegExp(
  `^${MARKDOWN_IMAGE_URL_PREFIX}`
);
