...
export async function userAccountRegisteredT(recipient: User): Promise<Emails> {
  ...
  const description =
    "Thank you for creating an account for the Digital Marketplace web application.";
  return [
    {
      to: recipient.email || [],
      subject: title,
...
export async function inviteToRegisterT(
  email: string,
      ...
      html: templates.simple({
        ...
        body: (
          <div>
            ...
            <p>
              In order to join the organization{"'"}s team you must first{" "}
              <templates.Link
                text="sign up"
  ...
  return [
    {
      ...
      html: templates.simple({
        ...
        body: (
          <div>
            <p>
              You have successfully deactivated your Digital Marketplace
              account.
            </p>
            <p>
              You can reactivate your account by signing into the web
              application again.
            </p>
          </div>
        ),
  ...
  return [
    {
      ...
      html: templates.simple({
        ...
        body: (
          <div>
            <p>
              Your Digital Marketplace account has been deactivated by an
              administrator.
            </p>
...
export async function accountReactivatedSelfT(user: User): Promise<Emails> {
  ...
  const description =
    "You have successfully reactivated your Digital Marketplace account.";
  return [
    {
  ...
  return [
    {
      ...
      html: templates.simple({
        ...
        body: (
          <div>
            <p>
              Your Digital Marketplace account has been reactivated by an
              administrator.
            </p>
            <p>
              If you have any questions, you can send an email to the Digital
