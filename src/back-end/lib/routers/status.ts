import { makeTextResponseBody, nullRequestBodyHandler, Route, Router, TextResponseBody } from 'back-end/lib/server';
...
const router: Router<any, any, any, any, TextResponseBody, any, any> = [ statusRoute ];
