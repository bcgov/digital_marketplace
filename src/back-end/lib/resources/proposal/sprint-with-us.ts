...
interface ValidatedCreateRequestBody
  extends Omit<CreateRequestBody, "attachments"> {
      ...
      async parseRequestBody(request) {
        ...
        switch (tag) {
          ...
          case "scoreQuestions":
            return adt(
              "scoreQuestions",
              value as UpdateTeamQuestionScoreBody[]
            );
          ...
          case "edit": {
            ...
            const validatedTotalProposedCost =
              proposalValidation.validateSWUProposalProposedCost(
                getValidValue(validatedInceptionPhase, null)?.proposedCost || 0,
                getValidValue(validatedPrototypePhase, null)?.proposedCost || 0,
                getValidValue(validatedImplementationPhase, null)
                  ?.proposedCost || 0,
            ...
            if (
              !allValid([
                ...
                proposalValidation.validateSWUProposalProposedCost(
                  ...
                  validatedSWUProposal.value.implementationPhase
                    ?.proposedCost || 0,
                  swuOpportunity.totalMaxBudget
                ),
