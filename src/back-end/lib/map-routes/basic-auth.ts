...
function addBasicAuth<IReq, PReq, VReq, ReqE, Res, Session>(username: string, passwordHash: string): MapHandler<IReq, PReq, PReq, VReq, BasicAuthRequestBody<VReq>, ReqE, ReqE, Res, Res | UnauthorizedResponseBody, Session> {
  return oldHandler => ({
    ...
    async validateRequestBody(request) {
      ...
      if (!authorized) { return valid(unauthorized); }
...
interface Params<IReq, PReq, VReq, ReqE, Res, HookState, Session> {
  username: string;
  passwordHash: string;
  mapHook: MapHook<IReq, VReq, BasicAuthRequestBody<VReq>, ReqE, ReqE, Res, Res | UnauthorizedResponseBody, HookState, HookState, Session>;
}

export default function<IReq, PReq, VReq, ReqE, Res, HookState, Session>(params: Params<IReq, PReq, VReq, ReqE, Res, HookState, Session>): MapRoute<IReq, PReq, PReq, VReq, BasicAuthRequestBody<VReq>, ReqE, ReqE, Res, Res | UnauthorizedResponseBody, HookState, HookState, Session> {
