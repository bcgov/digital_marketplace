...
describe("As a user authenticated via IDIR", function () {
  ...
  it("update an existing SWU opportunity", function () {
    ...
    cy.get('div[class="pt-2 pb-4 mb-4"]')
      .eq(0)
      .contains("Agile Coaching")
      .click();
    cy.get('div[class="pt-2 pb-4 mb-4"]')
      .eq(0)
      .contains("User Experience Design")
      .click();
    cy.get('div[class="pt-2 pb-4 mb-4"]')
      .eq(0)
      .contains("Backend Development")
    ...
    cy.get('div[class*="modal-footer"]')
      .children()
      .contains("Submit Changes")
      .click();
    cy.contains(
      "Your changes to this Sprint With Us opportunity have been saved."
    ).should("be.visible");
    ...
    cy.get("#swu-opportunity-total-max-budget").should("have.value", "5000000");
    ...
    // 3. Phases tab
    cy.get("#swu-opportunity-starting-phase").should(
      "have.text",
      "Proof of Concept"
    );
    // eslint-disable-next-line
    ...
    cy.get('div[class="pt-2 pb-4 mb-4"]')
      .eq(0)
      .contains("Agile Coaching")
      .should("include.text", "Agile Coaching");
    cy.get('div[class="pt-2 pb-4 mb-4"]')
      .eq(0)
      .contains("User Experience Design")
      .should("include.text", "User Experience Design");
    ...
    cy.get('div[class="pt-2 pb-4 "]')
      .contains("DevOps Engineering")
      .should("include.text", "DevOps Engineering");
