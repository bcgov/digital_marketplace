...
describe("As a user authenticated via IDIR", function () {
  ...
  it("update an existing CWU opportunity", function () {
    ...
    cy.get('div[class*="modal-footer"]')
      .children()
      .contains("Publish Changes")
      .click();
    cy.contains(
      "Your changes to this Code With Us opportunity have been published."
    ).should("be.visible");
  ...
  it("suspend an existing CWU opportunity", function () {
    ...
    cy.get('div[class*="modal-footer"]')
      .children()
      .contains("Suspend Opportunity")
      .click();
    cy.contains("Code With Us opportunity has been suspended.").should(
      "be.visible"
    );
  ...
  it("archive an existing CWU opportunity", function () {
    ...
    cy.get('div[class*="modal-footer"]')
      .children()
      .contains("Cancel Opportunity")
      .click();
    cy.contains("Code With Us opportunity has been cancelled.").should(
      "be.visible"
    );
