module.exports = {
  ...
  frontEndViteBuildDev: "NODE_ENV=development vite build --mode development",
  frontEndViteBuildProd: "NODE_ENV=production vite build --mode production",
  frontEndViteWatch:
    "NODE_ENV=development vite build --watch --mode development",
